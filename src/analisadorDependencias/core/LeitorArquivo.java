...
public class LeitorArquivo {
	...
	public static String lerArquivo(String extensaoArquivo) throws Exception {
		...
		fileChooser.setFileFilter(
				new FileNameExtensionFilter("Arquivos " + extensaoArquivo.toUpperCase(), extensaoArquivo));
		...
		try (BufferedReader reader = new BufferedReader(new FileReader(caminhoArquivo))) {
			int tamanhoStringBuilder = extensaoArquivo.equals("html") ? TAMANHO_STRINGBUILDER_HTML
					: TAMANHO_STRINGBUILDER_TXT;
